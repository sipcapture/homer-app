    /*next*/    
    var injectTransactionRegistrationCtrlParams = ['$scope','searchService','$homerModal','$homerCflow','$timeout','$homerModalParams', '$sce', 'localStorageService','$filter'];
    
    var TransactionRegistrationCtrlController = function($scope, search, $homerModal, $homerCflow, $timeout, $homerModalParams, $sce, localStorageService, $filter) {
		    ...
		    $scope.drawCanvas($scope.id, $scope.transaction);
                ...
                $scope.enableRegistrationInfo = false;
		...
		$scope.protoCheck = function(proto) {
		    ...
		    // Reposition popup in visible area
                ...
                search.searchRegistrationByTransaction(data).then(function(msg) {
                        if (msg) {
    ...
    TransactionRegistrationCtrlController.$inject = injectTransactionRegistrationCtrlParams;
export default TransactionRegistrationCtrlController;    

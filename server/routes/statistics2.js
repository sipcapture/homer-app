...
import Joi from 'joi';
import Stats from '../classes/statistics2';

export default function statistics2(server) {
  server.route({

    path: '/api/v3/statistic2/_db',
    method: 'GET',
    config: {
      cors: {
            origin: ['*'],
  ...
  server.route({
    ...
    path: '/api/v3/statistic2/_retentions',
    method: 'POST',
    config: {
      auth: {
        strategy: 'token',
  ...
  server.route({
    ...
    path: '/api/v3/statistic2/_measurements/{databaseId}',
    method: 'GET',
    config: {
      auth: {
        strategy: 'token',
  ...
  server.route({
    ...
    path: '/api/v3/statistic2/_fields',
    method: 'POST',
    config: {
      auth: {
        strategy: 'token',
  ...
  server.route({
    ...
    path: '/api/v3/statistic2/_metrics',
    method: 'POST',
    config: {
      auth: {
        strategy: 'token',

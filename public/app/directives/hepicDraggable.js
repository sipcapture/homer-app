    var injectDraggableParams = [];
    var hepicDraggableDirective = function () {
	return {
              restrict: 'EA',
              link: function(scope, element) {
                        ...
                        .resizable({
                           resize: function (evt, ui) {
                                var canv = $(element).find('#cflowsvg');
                                if($(canv).length > 0) scope.reApplyResize(ui.size);
    ...
    hepicDraggableDirective.$inject = injectDraggableParams;
export default hepicDraggableDirective;
